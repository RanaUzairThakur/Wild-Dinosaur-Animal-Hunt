...
public class RenderSettingsManager : MonoBehaviour
{
    ...
    public void OptimizeGameplay()
    {
        ...
        if (!OptimizationMessageGiven)
        {
            ...
            if (FindObjectOfType<AdsManager>())
                FindObjectOfType<AdsManager>().Islowenddevice = true;
    ...
    public void CalculateSystemScore()
    {
        ...
        this.totalRam = SystemInfo.systemMemorySize / 1000;
        //s this.totalRam = 1024 / 1000;

        //long ram = System.GC.GetTotalMemory(false);
        //print("System.GC.GetTotalMemory :" + ram/MemoryDivider);
    ...
    //public const long MemoryDivider = 1048576;
    //public void Memory()
    //{
    //    long GetTotalReservedMemoryLong = Profiler.GetTotalReservedMemoryLong();
    //    long GetTotalAllocatedMemoryLong = Profiler.GetTotalAllocatedMemoryLong();
    //    long GetTotalMemory = System.GC.GetTotalMemory(false);
    //    long GetAllocatedMemoryForGraphicsDriver = Profiler.GetAllocatedMemoryForGraphicsDriver();
    //    GetTotalReservedMemoryLong = GetTotalReservedMemoryLong / MemoryDivider;
    //    GetTotalAllocatedMemoryLong = GetTotalAllocatedMemoryLong / MemoryDivider;
    //    GetTotalMemory = GetTotalMemory / MemoryDivider;
    //    GetAllocatedMemoryForGraphicsDriver = GetAllocatedMemoryForGraphicsDriver / MemoryDivider;
    //    print("GetTotalReservedMemoryLong :" + GetTotalReservedMemoryLong);
    //    print("GetTotalAllocatedMemoryLong :" + GetTotalAllocatedMemoryLong);
    //    //print("GetTotalMemory :" + GetTotalMemory);
    //    //print("GetAllocatedMemoryForGraphicsDriver :" + GetAllocatedMemoryForGraphicsDriver);
    //}
    //void OnGUI()
    //{
    //    Memory();
